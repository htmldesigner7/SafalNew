...
export const pagesData: Record<string, { hero: HeroContent }> = {
  about: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/our-story/our-story.webp`,
  ...
  contact: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/banner-images/contact.webp`,
  ...
  ourEntities: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Group-Structure/Group-Structure.webp`,
      imageAlt: "Contact Hero Email Graphic",
    }
  },
  ...
  investorRelations: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Values-&-Culture/Values-&-Culture.webp`,
  ...
  lifeAtSafal: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/life-at-safal/Life-at-Safal.webp`,
  ...
  jobDetails: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Open-Positions/Open-Positions.webp`,
  ...
  internshipsMentorship: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/banner-images/Internships-&-Mentorship.webp`,
  ...
  financialReports: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Financial-Reports-&-Disclosures/Financial-Reports-&-Disclosures.webp`,
  ...
  LeaderShipTeam: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/LeaderShip-Team/Leadership-Team.webp`,
      imageAlt: "Blogs Hero Image",
    }
  },
  Valuesandculture: {
  ...
  technologyStaffing: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Technology-Staffing/Technology-Staffing.webp`,
  ...
  startupProductDevelopment: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Startup-Product-Development-&-Consulting/Startup-Product-Development-Consulting.webp`, // Replace with correct image from the design
  ...
  enterpriseProducts: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Enterprise-Grade-Products-Built-for-Scale/Enterprise-Grade-Products-Built-for-Scale.webp`,
  ...
  industrialAutomation: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Industrial-Automation-&-IoT/Industrial-Automation-&-IoT.webp`,
  ...
  aiEmergingTechnology: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/AI-&-Emerging-Technology/banner.webp`,
  ...
  financialAccountingSolutions: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/financial-accounting-solutions/financial-accounting-solutions.webp`,
  ...
  brandDigitalCreativeServices: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/Brand,-Digital-&-Creative-Services/Brand,-Digital-&-Creative-Services.webp`,
  ...
  sustainability: {
    hero: {
      ...
      imageSrc: `${baseUrl}/images/banner-images/Sustainability.webp`,
