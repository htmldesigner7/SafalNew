...
const pageData = {
  hero: {
    ...
    imageSrc: `${baseUrl}/images/Industrial-Automation-&-IoT/Technology-Aligned-Implementation.webp`,
  ...
  talent: {
    ...
    imageSrc: `${baseUrl}/images/Technology-Staffing/Technology-Talent.webp`,
