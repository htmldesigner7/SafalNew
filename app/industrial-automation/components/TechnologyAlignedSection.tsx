      ...
      <div className="container-1600">
        <div className={sysStyles.contentWrapper}>
          <div className={sysStyles.textContent}>
            <h2 className={`title_60 ${sysStyles.title}`}>Technology-Aligned<br />Implementation</h2>
            <p>Safal's solutions are built on industry-standard technologies, protocols, and scalable architectures. As part of its Industry 4.0 consulting approach, the focus remains on interoperability, reliability, and long-term maintainability.</p>
