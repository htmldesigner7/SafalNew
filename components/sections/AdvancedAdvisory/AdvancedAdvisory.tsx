...
const tabsData = [
  {
    ...
    iconSrc: `${baseUrl}/images/Business-&-Financial-Advisory/Tax-Advisory.svg` // Replace with actual TAX icon later
  },
  {
    id: "valuation",
    tabLabel: "Valuation",
    ...
    iconSrc: `${baseUrl}/images/Business-&-Financial-Advisory/Valuation.svg` 
  },
  {
    ...
    iconSrc: `${baseUrl}/images/Business-&-Financial-Advisory/Transaction-Advisory.svg`
  }
];
      ...
      <div className="container-1600">
        ...
        <div className={styles.layout}>
          ...
          <div className={styles.imageCol}>
            <Image 
              src={`${baseUrl}/images/Business-&-Financial-Advisory/Advanced-Financial-&-Regulatory-Advisory.webp`} 
