        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.stagesList}>
            ...
            <div className={styles.svgContainer}>
              <svg width="645" height="400" viewBox="0 0 645 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                ...
                <path
                  ...
                  strokeWidth="2.72"
                  strokeLinecap="round"
                  strokeDasharray="36.27 181.33"
                />

                <rect x="1.5" y={activeY - 7.5} width="15" height="15" rx="7.5" fill="#EA580C" stroke="white" strokeWidth="3" />
