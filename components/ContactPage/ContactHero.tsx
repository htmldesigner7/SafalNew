      ...
      <div className={`${styles.contentContainer} container-1800`}>
        ...
        <div className={styles.textContent}>
          ...
          <p className={styles.description}>
            Whether you require robust enterprise infrastructure, visionary creative strategy, or elite financial advisory, our global team is ready to engineer your solution. Connect with Safal Infosoft to begin.
          </p>
        </div>
        ...
        <div className={styles.visualContent}>
          <div className={styles.graphicWrapper}>
            <Image 
              ...
              alt="Contact Hero Email Graphic" 
              width={600} 
              height={600}
