...
export default function ContactLocations() {
  return (
    <section className={`${styles.locationSection} mt_80`}>
      ...
      <div className={`${styles.container} container-1600`}>
        ...
        <div className={styles.locationsContainer}>
          ...
          <div className={styles.indiaOfficeBlock}>
            <h3 className={styles.officeName}>India Office</h3>
            <div className={styles.indiaOfficeContent}>
              <div className={styles.addressItem}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={styles.icon}>
          ...
          <div className={styles.bottomOfficesRow}>
            ...
            <div className={styles.officeBlock}>
              <h3 className={styles.officeName}>UAE Office</h3>
              <div className={styles.addressItem}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={styles.icon}>
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                  <circle cx="12" cy="10" r="3"></circle>
            ...
            {/* USA Office */}
            <div className={styles.officeBlock}>
              <h3 className={styles.officeName}>USA Office</h3>
              <div className={styles.addressItem}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={styles.icon}>
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                  <circle cx="12" cy="10" r="3"></circle>
