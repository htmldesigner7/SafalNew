...
export const startupProductDevBannerData: BannerCTAData = {
  ...
  buttonLink: '/contact',
  bgImageSrc: `${siteUrl}/images/Startup-Product-Development-&-Consulting/cta.webp`,
};

export const aiEmergingTechBannerData: BannerCTAData = {
  iconSrc: `${siteUrl}/images/favicon_new.png`,
  ...
  buttonText: 'Book a Consultation',
  buttonLink: '/contact',
  bgImageSrc: `${siteUrl}/images/AI-&-Emerging-Technology/cta-banner.webp`,
};
